...
```sh
docker run -d -p 80:80 --name maintanance-page pausabates/http80-maintenance-web:1.0.0
```

- HTTPS:

Your web will normally run after a lb or reverse proxy that redirects https to http. So basically SSL offloading.
